...
describe('User Registration', () => {
  ...
  it.each`
    ...
    ${'password'} | ${'123465869'}     | ${'Password must have at least 1 uppercase, 1 lowercase letter and 1 number'}
    ${'password'} | ${'lowerandUPPER'} | ${'Password must have at least 1 uppercase, 1 lowercase letter and 1 number'}
    ${'password'} | ${'lower4nd59943'} | ${'Password must have at least 1 uppercase, 1 lowercase letter and 1 number'}
